...
$(document).ready(function () {
	// 模拟数据，可以 Ajax 请求服务器数据，添加大转盘的奖品与奖品区域背景颜色
	...
	turnWheel.colors = [
		"#FFD700", "#FFA07A", // 金色和浅橙色
		"#87CEEB", "#98FB98", // 天蓝色和淡绿色
		"#FFB6C1", "#DDA0DD", // 粉红色和浅紫色
		"#FFA07A", "#87CEEB", // 浅橙色和天蓝色
		"#98FB98", "#FFD700", // 淡绿色和金色
		"#DDA0DD", "#FFB6C1"  // 浅紫色和粉红色
	];
	...
	function updateRecord(reward) {
		...
		recordText.textContent = reward; // 更新中奖记录内容
	}
});
